SMODS.Joker{ --The Fungus
    ...
    loc_txt = {
        ...
        ['text'] = {
            ...
            [2] = 'and add the Joker\'s {C:attention}sell value{} to {X:planet,C:white}multiplier{}',
            [3] = 'Multiply {X:planet,C:white}^Chips{} by {X:planet,C:white}multipier{} when hand is played',
            [4] = '(Currently {X:planet,C:white}^#1#{} Chips, {X:planet,C:white}x#2#{})',
    ...
    loc_vars = function(self, info_queue, card)
        return {vars = {card.ability.extra.chips, card.ability.extra.multiplier}}
    end,
    ...
    calculate = function(self, card, context)
        if context.setting_blind  and not context.blueprint then
                ...
                if target_joker then
                    ...
                    card.ability.extra.multiplier = card.ability.extra.multiplier + sell_value_gain
        ...
        if context.cardarea == G.jokers and context.joker_main  then
                card.ability.extra.chips = (card.ability.extra.chips) * card.ability.extra.multiplier
                return {
