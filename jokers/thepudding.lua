SMODS.Joker{ --The Pudding
    ...
    loc_txt = {
        ...
        ['text'] = {
            ...
            [4] = 'Each {C:dark_edition,E:1}Peculiar{} Joker gives',
            [5] = '{X:legendary,C:white}^#1#{} Mult'
        },
        ['unlock'] = {
            [1] = ''
        }
    ...
    return rankCount >= 1
                ...
                G.E_MANAGER:add_event(Event({
                    func = function()
                        SMODS.add_card{set = 'Spectral', key = 'c_pudding_sholium', edition = 'e_negative', key_append = 'joker_forge_spectral'}
                        return true
                    end
                }))
                return {
