SMODS.Joker{ --Pouakai
    ...
    in_pool = function(self, args)
          return not args or args.source ~= 'jud' and args.source ~= 'rif' and args.source ~= 'sou' and args.source ~= 'uta' and args.source ~= 'wra' or args.source == 'sho' or args.source == 'buf' or args.source == 'rta'
      end
    ,
